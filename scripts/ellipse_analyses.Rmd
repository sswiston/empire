...
Packages required for these analyses: ape, corrr, devtools, dplyr, empire, geojsonsf, ggplot2, ggtree, grid, gridExtra, HDInterval, httr2, knitr, lubridate, mcmcse, patchwork, phytools, rase, raster, rgplates, sf, sfheaders, spatstat, stringr, treeio
...
#       iterations <- as.numeric(unlist(strsplit(system(paste0("wc -l ",directory,"rase.csv"),intern=TRUE),"/V")[[1]][1]))
...
Here are the run times for the simulation analyses based on the sizes of the phylogenetic trees. Note that there is a logarithmic relationship. Oddly, some analyses performed much better.
