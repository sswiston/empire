...
maps_directory <- paste0(plot_directory,"range_maps/")
...
plot_with_vectors <- ggplot(spheno_shapes) +
  ...
  theme(panel.border = element_rect(color=lines_color,linewidth=2),
        panel.background = element_rect(fill=background_color))
ggsave(paste0(maps_directory,"australia_with_vectors.png"),plot_with_vectors,dpi=600)
...
ggsave(paste0(maps_directory,"vectors_and_map.png"),vectors_and_map,dpi=600,width=7,height=3.5)
```
...
plot_without_ranges <- ggplot(spheno_shapes) +
  ...
  theme(panel.border = element_rect(color=lines_color,linewidth=2),
        panel.background = element_rect(fill=background_color))
ggsave(paste0(maps_directory,"australia_no_ranges.png"),plot_without_ranges,dpi=600)
```
...
plot_with_ranges <- ggplot(spheno_shapes) +
  ...
  theme(panel.border = element_rect(color=lines_color,linewidth=2),
        panel.background = element_rect(fill=background_color))
ggsave(paste0(maps_directory,"australia_with_ranges.png"),plot_with_ranges,dpi=600)
```
...
plot_with_ellipses <- ggplot(spheno_shapes) +
  ...
  theme(panel.border = element_rect(color=lines_color,linewidth=2),
        panel.background = element_rect(fill=background_color))
ggsave(paste0(maps_directory,"australia_with_ellipses.png"),plot_with_ellipses,dpi=600)
```

```{r modern_ellipses_by_species, include=FALSE, message=FALSE, eval=FALSE}
...
#   theme(panel.border = element_rect(color=lines_color,linewidth=2),
#         panel.background = element_rect(fill=background_color))
# ggsave(paste0(maps_directory,"species/",i,"_",gsub(" ","_",species),".png"),plot_species,dpi=600)
# }
```
...
# NEXT TIME YOU RUN THIS, ADD A PROGRESS BAR
