...
#' @details This object is used during simulation to contain the model parameters used for generating data (W, V, XY). It is also used during analysis to store current parameter values.
  ...
  #' @field rho_m An object of class "vector" containing two numeric elements: the prior probability of cladogenetic mode 1 (sympatry) and the prior probability of cladogenetic mode 2 (allopatry). The default value assigns probability 0.5 to both modes.
...
public = list(
  ...
  #' @param rho_m An object of class "vector" containing two numeric elements: the prior probability of cladogenetic mode 1 (sympatry) and the prior probability of cladogenetic mode 2 (allopatry). The default value assigns probability 0.5 to both modes.
